                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label>Section Name </label>
                                                                            <select  name="section_name"  class="form-control" required>
																																			<option value="logo" @if($val->section_name == 'logo')selected @endif>LOGO SECTION</option>
...
<option value="bottom"@if($val->section_name == 'bottom')selected @endif>Bottom Section</option>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="logo" class="form-control" >
                                                                        @if($val->logo)
                                                                        <img src="{{asset($val->logo)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="slider_image" class="form-control">
                                                                        @if($val->slider_image)
                                                                        <img src="{{asset($val->slider_image)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="right_image" class="form-control">
                                                                        @if($val->right_image)
                                                                        <img src="{{asset($val->right_image)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="left_image" class="form-control">
                                                                        @if($val->left_image)
                                                                        <img src="{{asset($val->left_image)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="icon_image_1" class="form-control">
                                                                        @if($val->icon_image_1)
                                                                        <img src="{{asset($val->icon_image_1)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input type="file" name="icon_image_3" class="form-control">
                                                                        @if($val->icon_image_3)
                                                                        <img src="{{asset($val->icon_image_3)}}"  class="form-control">
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
